        ...
        c.VERSION = "1.12.4", c.DEFAULTS = {
            ...
            createLi: function() {
                ...
                return k.each(function(t) {
                    ...
                    if (C++, !e.hasClass("bs-title-option")) {
                        ...
                        else if (!0 === e.data("hidden")) i = e.data("prevHiddenIndex"), e.next().data("prevHiddenIndex", void 0 !== i ? i : t), y.push(S($(o, s, n, a), t, "hidden is-hidden"));
                        else {
                    ...
                    if (y.multiple && 1 !== y.options.maxOptions && t.stopPropagation(), t.preventDefault(), !y.isDisabled() && !e.parent().hasClass("disabled")) {
                        ...
                        if (y.multiple) {
                            if (r.prop("selected", !l), y.setSelected(i, !l), e.blur(), !1 !== d || !1 !== p) {
                                ...
                                if (d && c || p && u)
                                    if (d && 1 == d) a.prop("selected", !1), r.prop("selected", !0), y.$menuInner.find(".selected").removeClass("selected"), y.setSelected(i, !0);
                                    else if (p && 1 == p) {
            ...
            liveSearchListener: function() {
                ...
                this.$button.on("click.dropdown.data-api", function() {
                    ...
                    if (n.$lis.not(".is-hidden").removeClass("hidden"), n.$lis.filter(".active").removeClass("active"), o.remove(), n.$searchbox.val()) {
                        ...
                        if ((t = n.options.liveSearchNormalize ? e.not(":a" + n._searchStyle() + '("' + a(n.$searchbox.val()) + '")') : e.not(":" + n._searchStyle() + '("' + n.$searchbox.val() + '")')).length === e.length) o.html(n.options.noneResultsText.replace("{0}", '"' + R(n.$searchbox.val()) + '"')), n.$menuInner.append(o), n.$lis.addClass("hidden");
                        else {
                            t.addClass("hidden");
            ...
            keydown: function(e) {
                ...
                if ((/(13|32)/.test(e.keyCode.toString(10)) || /(^9$)/.test(e.keyCode.toString(10)) && a.options.selectOnTab) && n) {
                    if (/(32)/.test(e.keyCode.toString(10)) || e.preventDefault(), a.options.liveSearch) /(32)/.test(e.keyCode.toString(10)) || (a.$menuInner.find(".active a").click(), o.focus());
                    else {
                        var p = T(":focus");
            ...
            return this.each(function() {
                ...
                if (c.parent().hasClass(R.wrapperClass)) {
                    ...
                    if (b = c.closest("." + R.barClass), v = c.closest("." + R.railClass), C(), T.isPlainObject(k)) {
                        ...
                        else if ("destroy" in k) return b.remove(), v.remove(), void c.unwrap();
                        w(u, !1, !0)
                    }
                    ...
                    }), C(), "bottom" === R.start ? (b.css({
                        top: c.outerHeight() - b.outerHeight()
                    }), w(0, !0)) : "top" !== R.start && (w(T(R.start).position().top, null, !0), R.alwaysVisible || b.hide()), m = this, window.addEventListener ? (m.addEventListener("DOMMouseScroll", y, !1), m.addEventListener("mousewheel", y, !1)) : document.attachEvent("onmousewheel", y)
                }
                ...
                function w(t, e, i) {
                    ...
                    if (e && (s = parseInt(b.css("top")) + t * parseInt(R.wheelStep) / 100 * b.outerHeight(), s = Math.min(Math.max(s, 0), n), s = 0 < t ? Math.ceil(s) : Math.floor(s), b.css({
                            top: s + "px"
                        })), s = (r = parseInt(b.css("top")) / (c.outerHeight() - b.outerHeight())) * (c[0].scrollHeight - c.outerHeight()), i) {
                        var o = (s = t) / c[0].scrollHeight * c.outerHeight();
                        o = Math.min(Math.max(o, 0), n), b.css({
                            top: o + "px"
                        })
                    }
                ...
                function C() {
                    a = Math.max(c.outerHeight() / c[0].scrollHeight * c.outerHeight(), d), b.css({
                        height: a + "px"
                    });
...
function(t, e) {
    ...
    return e.init = function(t) {
        ...
        for (var e = {
                type: "mouseup",
                button: 1
            }, i = 0, s = (t = d(t)).length; i < s; i++) u.hide(e, t[i])
...
function($, N, B) {
    ...
    t = function(_) {
        "use strict";
        var t, e, v, j, y, W, O, z, d, C, i, o, p, q, c, s, n, L, D, r, a, l, h, w, u, g, f, m, b, x = {},
            S = 0;
        t = function() {
            return {
                common: {
            ...
            return this.each(function() {
                var t, e, r = new _.fn.sparkline.options(this, i),
                    l = _(this);
                if (t = function() {
                        var t, e, i, s, n, o, a;
                    ...
                    if (!r.get("composite") && _.data(this, "_jqs_pending"))
                        for (e = b.length; e; e--) b[e - 1][0] == this && b.splice(e - 1, 1);
            ...
            getTagSetting: function(t) {
                ...
                if (this.tagValCache.hasOwnProperty(t)) e = this.tagValCache.key;
                    ...
                    if ((e = this.tag.getAttribute(o + t)) === B || null === e) e = x;
                        ...
                        for (i = (e = e.substr(1, e.length - 2).split(",")).length; i--;) e[i] = W(e[i].replace(/(^\s*)|(\s*$)/g, ""));
                    else if ("{" === e.substr(0, 1))
                        for (s = e.substr(1, e.length - 2).split(","), e = {}, i = s.length; i--;) e[(n = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = W(n[1].replace(/(^\s*)|(\s*$)/g, ""));
                    else e = W(e);
            ...
            getCurrentRegionTooltip: function() {
                var t, e, i, s, n, o, a, r, l, h, d, p, c, u, g = this.options,
                    f = "",
                    m = [];
                ...
                for (i = e.length, c = t.length, o = 0; o < i; o++)
                    for ("string" == typeof(p = e[o]) && (p = new v(p)), s = p.fclass || "jqsfield", u = 0; u < c; u++) t[u].isNull && g.get("tooltipSkipNull") || (_.extend(t[u], {
            ...
            calcHighlightColor: function(t, e) {
                var i, s, n, o, a = e.get("highlightColor"),
            ...
            render: function() {
                ...
                if (L._super.render.call(this) && (this.scanValues(), this.processRangeOptions(), w = this.xvalues, C = this.yvalues, this.yminmax.length && !(this.yvalues.length < 2))) {
                    ...
                    if (E && $.get("valueSpots"))
                        for ((b = $.get("valueSpots")).get === B && (b = new q(b)), S = 0; S < g; S++)(y = b.get(C[S])) && k.drawCircle(n + N.round((w[S] - this.minx) * (R / t)), s + N.round(T - T * ((C[S] - this.miny) / e)), E, B, y).append();
            ...
            init: function(t, e, i, s, n) {
                ...
                for (d = 0, p = e.length; d < p; d++)
                    if (x)
                        for (y = e[d], e[d] = S = [], A[d] = 0, l[d] = P[d] = 0, w = 0, C = y.length; w < C; w++) null !== ($ = S[w] = H ? j(y[w], v, b) : y[w]) && (0 < $ && (A[d] += $), L < 0 && 0 < M ? $ < 0 ? P[d] += N.abs($) : l[d] += $ : l[d] += N.abs($ - ($ < 0 ? M : L)), h.push($));
                    else $ = H ? j(e[d], v, b) : e[d], null !== ($ = e[d] = W($)) && h.push($);
            ...
            calcColor: function(t, e, i) {
                var s, n, o = this.colorMapByIndex,
            ...
            renderRegion: function(t, e) {
                var i, s, n, o, a, r, l, h, d, p, c = this.values[t],
                    u = this.options,
                    g = this.xaxisOffset,
                    f = [],
                    m = this.range,
            ...
            init: function(t, e, i, s, n) {
                var o, a = 0;
                if (h._super.init.call(this, t, e, i, s, n), this.shapes = {}, this.valueShapes = {}, this.values = e = _.map(e, Number), "auto" === i.get("width") && (this.width = this.height), 0 < e.length)
            ...
            getCurrentRegionFields: function() {
                ...
                return this.loutlier !== B && t.push({
                    ...
                    field: "lw",
                    value: this.lwhisker
                }), this.rwhisker !== B && t.push({
                    field: "rw",
                    value: this.rwhisker
                }), t
            },
            render: function() {
                var t, e, i, s, n, o, a, r, l, h, d, p = this.target,
                    c = this.values,
                    u = c.length,
                    g = this.options,
                    f = this.canvasWidth,
                    ...
                    b = g.get("chartRangeMax") === B ? N.max.apply(N, c) : g.get("chartRangeMax"),
                    x = 0;
                if (w._super.render.call(this)) {
                    if (g.get("raw")) g.get("showOutliers") && 5 < c.length ? (e = c[0], t = c[1], s = c[2], n = c[3], o = c[4], a = c[5], r = c[6]) : (t = c[0], s = c[1], n = c[2], o = c[3], a = c[4]);
                    else if (c.sort(function(t, e) {
                            return t - e
