...
function(e, t) {
    ...
    var O = "carousel",
        ...
        ae = function() {
            ...
            return e.next = function() {
                ...
                if (r = e === M ? (n = z, i = Y, W) : (n = V, i = X, B), l && p(l).hasClass($)) this._isSliding = !1;
    ...
    p.fn[Wi] = Zi._jQueryInterface, p.fn[Wi].Constructor = Zi, p.fn[Wi].noConflict = function() {
        ...
        }(), e.Util = g, e.Alert = m, e.Button = k, e.Carousel = ae, e.Collapse = Te, e.Dropdown = Yt, e.Modal = mn, e.Popover = ii, e.Scrollspy = Ti, e.Tab = Fi, e.Toast = Zi, e.Tooltip = Un, Object.defineProperty(e, "__esModule", {
            value: !0
        })
});